...
<head>
	<meta charset="UTF-8">
	<title>@section('title') Kenn Shop @show</title>
	...
	<nav id="header-nav" class="navbar navbar-default" role="navigation">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="{!! url('/') !!}">Kenn Shop</a>
			</div>
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li id="btnBestSeller"><a href="#">Sản phẩm bán chạy</a></li>
					<li class="dropdown">
					...
					<li id="accountHome">
						...
						<ul class="dropdown-menu">
							<li id="btnProfile" data-account="<?php echo $savedAccount['id'] ?>"><a>Hồ sơ</a></li>
	...
	<footer class="container footer">
		<div class="row text-center">
			...
			<div class="col-md-6 col-md-push-3">
				<span><b>Address:</b>90/12 An Nhơn, Gò vâp</span><br>
				<span><b>Phone:</b> 01883429909</span><br>
				<span><b>Email:</b> kien20397@gmail.com</span><br>
