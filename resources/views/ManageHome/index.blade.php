  ...
  <div class="wrapper">
    <header class="main-header" style="">
      ...
      <a class="logo">
        ...
        <span class="logo-lg">Kenn Shop</span>
      </a>
      <!-- Right header user -->
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span visible class="hidden-xs"><?php echo  isset($user['username'])? $user['username'] : "Kenn"; ?> </span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a class="btn btn-default btn-flat getView" data-view="profile" id='btnProfile'>Hồ sơ</a>
                  </div>
                  <div class="pull-right">
                    <a class="btn btn-default btn-flat" id='btnLogout'>Đăng xuất</a>
                  </div>
                </li>
              </ul>
            </li>
